	...
	<div class="box span12">
		...
		<form action="{{URL::to('/update-product',$edit_product->id)}}" method="post" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="input-xlarge" name="product_name" value="{{$edit_product->product_name}}" required>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="number" class="input-xlarge" value="{{$edit_product->price}}" name="product_price" required>
				</div>
			</div>
			...
			<div class="control-group">
			 ...
			 <div class="control-group">
				...
				<div class="controls">
					<textarea id="product_name" name="product_description" class="input-xlarge" required cols="8" rows="9">{{$edit_product->description}}</textarea>
				</div>
			</div>
