...
<body>
			...
			<div id="sidebar-left" class="span2" style="background-color: #002347"> 
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URl::to('/view-products')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">View Products</span></a></li>

						<li><a href="{{URl::to('/view-categories')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">View Categories</span></a></li>

						<li><a href="{{URl::to('/view-buyers')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">View Buyers</span></a></li>
	...
	<footer style="background-color: #002347">
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2021 <a href="http://localhost/ecommerce_api/public/index" alt="Bootstrap Themes" style="color: white" target="_blank">E Shopper</a></span>
